        ...
        <div className="left">
          <div className="left-top">
            ...
            <div className="descriptions">
              ...
              >
                ...
                Currently located in Rajasthan,India.
              </motion.p>
            </div>
          </div>
          <div className="left-bottom">
            ...
            <motion.a
              ...
              href="https://github.com/adityayaduvanshi"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <motion.a
              ...
              initial="initial"
              animate="animate"
              transition={{ ...transition, duration: 1, delay: 6.1 }}
              href="https://twitter.com/fixslyr"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <motion.a
              ...
              initial="initial"
              animate="animate"
              transition={{ ...transition, duration: 1, delay: 6.3 }}
              href="https://adityayaduvanshi.medium.com/"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="right">
          ...
          <div className="right-bottom">
            ...
            <motion.div className="link-container">
              ...
              >
                <a href="mailto:aditya.yadsr@gmail.com">
